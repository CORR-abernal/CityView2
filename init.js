require([
...
], function(WebMap, MapView, Search, Locate, Bookmarks, BasemapGallery, LayerList, Legend, Print, Home, ScaleBar, DistanceMeasurement2D, AreaMeasurement2D, Sketch, GraphicsLayer) {
  ...
  view.ui.move({component: "zoom", position: "top-right", index: 2});
